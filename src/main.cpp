...
// void incremental_encoder_begin() {
//     Serial.println("encoder 1 begin");
//     enc_1.begin();

//     Serial.println("encoder 2 begin");
//     enc_2.begin();

//     Serial.println("encoder 3 begin");
//     enc_3.begin();

//     Serial.println("all encoder begin");
// }
